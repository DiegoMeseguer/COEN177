...
// Date: 05/13/2023
// Title: Lab5 – step 1
// Description: The fourth solution solve the problem by using a
// while loop in one of the function, but it's difficult to convince
// ourselves that it works and it's too complex
