...
// Date: 05/13/2023
// Title: Lab5 – step 1
// Description: The first solution doesn't solve the Too Much Milk 
// problem because we can have a context switch before one of the 
// threads can leave the note, then the other thread can enter 
// the critical section at the same time and both will be 
// buying the milk.
